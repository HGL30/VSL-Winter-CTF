...
<h5 style="font-weight: bold; font-size: 32px; margin-top: 30px; margin-left: 20px;">Create Challenge</h5>
<div class="container">
    <div class="row">
        <div class="col-sm-10">
            <form action="{{ route('admin.challenge.store')}}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
